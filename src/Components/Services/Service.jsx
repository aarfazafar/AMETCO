...
const Services = () => {
 ...
 {/* Dynamic */}
      {/* Services Gallery */}
      <section ref={galleryRef} className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
              Professional craftsmanship across all service areas
            </p>
          </div>

          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="gallery-image group relative overflow-hidden rounded-lg shadow-lg">
              <img
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-4 left-4">
                  <p className="text-white font-medium text-sm">Construction</p>
                </div>
              </div>
            </div>
            ...
            <div className="gallery-image group relative overflow-hidden rounded-lg shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-4 left-4">
                  <p className="text-white font-medium text-sm">Electrical</p>
                </div>
              </div>
            </div>
            ...
            <div className="gallery-image group relative overflow-hidden rounded-lg shadow-lg">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-4 left-4">
                  <p className="text-white font-medium text-sm">Plumbing</p>
                </div>
              </div>
            </div>

            <div className="gallery-image group relative overflow-hidden rounded-xl shadow-lg">
              <img
                src="https://images.pexels.com/photos/1216589/pexels-photo-1216589.jpeg?auto=compress&cs=tinysrgb&w=400"
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <div className="absolute bottom-4 left-4">
                  <p className="text-white font-medium text-sm">Installation</p>
                </div>
              </div>
            </div>
          </div>
